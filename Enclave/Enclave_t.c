...
static sgx_status_t SGX_CDECL sgx_enclaveChangeBuffer(void* pms)
{
	...
	enclaveChangeBuffer(ms->ms_start_addr, ms->ms_end_addr);
...
SGX_EXTERNC const struct {
	...
	11,
	{
		...
		{(void*)(uintptr_t)sgx_get_pse_manifest_size, 0, 0},
		{(void*)(uintptr_t)sgx_get_pse_manifest, 0, 0},

...
typedef struct ms_enclaveChangeBuffer_t {
	unsigned long long ms_start_addr;
	unsigned long long ms_end_addr;
...
sgx_status_t enclaveChangeBuffer(sgx_enclave_id_t eid, unsigned long long start_addr, unsigned long long end_addr)
{
	sgx_status_t status;
	ms_enclaveChangeBuffer_t ms;
	ms.ms_start_addr = start_addr;
	ms.ms_end_addr = end_addr;

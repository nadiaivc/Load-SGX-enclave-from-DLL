...
int main()
{
	...
	/* Parse our options */
		...
		//--spid 14A1BE08C8B714BAF06F38CA6978FF84
		optarg = "14A1BE08C8B714BAF06F38CA6978FF84";
		if (strlen(optarg) < 32) {
		...
		optarg = "D:/VS/sgx-ra-sample-master2/sgx-ra-sample-master/vs/Intel_SGX_Attestation_RootCA.pem";
		//--ias-signing-cafile=D:/VS/sgx-ra-sample-master2/sgx-ra-sample-master/vs/Intel_SGX_Attestation_RootCA.pem
		...
		optarg = "bd71c6380ef77c5417e8b2d1ce2d4b6504b9f418e5049342440cfff2443d95bd";
		...
		//--ias-pri-api-key=53f52a903f0e4631b655030c62891d3c
		optarg = "53f52a903f0e4631b655030c62891d3c";
		...
		//--ias-sec-api-key=08b7e55339614d06b7fc22ab24ee67fd
		optarg = "08b7e55339614d06b7fc22ab24ee67fd";
		if (strlen(optarg) != IAS_SUBSCRIPTION_KEY_SIZE) {
...
/* Windows implementation is not available yet */
	...
	printf("msgio->send\n");
	//char mss[10] = "";
	rv = msgio->read((void**)&msg3, NULL);
	if (rv != NULL) {
		printf("msgio->read %s\n", msg3);
	}

	msgio->send("Okk", sizeof("Okk"));
	printf("msgio->send\n");
	...
	int strict_trust) 
{
	...
	} else if ( !(reportObj["isvEnclaveQuoteStatus"].ToString().compare("CONFIGURATION_NEEDED")) || !(reportObj["isvEnclaveQuoteStatus"].ToString().compare("CONFIGURATION_AND_SW_HARDENING_NEEDED"))) {
		if ( strict_trust ) {
